...
Esse projeto é uma API simples para marcar o que entra e o que sai de dinheiro.
...
1.  **Para ligar o servidor:**
   ``bash
     npm run dev
   ``
2.  **Para cadastrar um gasto/ganho:** Mande um POST no Postman para `http://localhost:3333/transactions`
3.  **Para ver a lista de tudo o que salvou:** Acesse no navegador ou Postman: `http://localhost:3333/transactions`
4.  **Para ver os gastos,ganhos e o saldo total:** Acesse no navegador ou Postman :`http://localhost:3333/transactions/balance`
